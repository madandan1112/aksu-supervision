...
import { getJobTitleList, createJobTitle, updateJobTitle, deleteJobTitle } from '@/api/system'
...
const getDefaultForm = () => ({ titleCode: '', titleName: '', category: 'TECHNICAL', isLeadership: 0, level: 1, sortOrder: 0, status: 1, description: '' })
...
const loadList = async () => {
  loading.value = true
  try { const res = await getJobTitleList({ page: 0, size: 999 }); tableData.value = res.data?.content || res.data || [] }
